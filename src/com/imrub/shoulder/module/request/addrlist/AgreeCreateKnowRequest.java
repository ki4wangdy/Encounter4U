...
public class AgreeCreateKnowRequest {

	public static void agreeCreateKnowRequest(final IRequestResult<Integer> result, int fromUid){
		
		final String postData = AddrlistRequestFactory.agreeCreateKnowRequest(fromUid);
		RequestUtils.doASyncRequest(HttpUrlConstant.HttpUrlAgreeKnow, postData, new IAction<String>() {
			@Override
