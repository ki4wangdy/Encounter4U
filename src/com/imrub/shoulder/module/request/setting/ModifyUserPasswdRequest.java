...
public class ModifyUserPasswdRequest {

	public static void modifyUserPasswd(final IRequestResult<String> result, String uid, String token, String pw){
		
		final String postData = SettingRequestFactory.modifyUserPasswd(uid, token, pw);
		RequestUtils.doASyncRequest(HttpUrlConstant.HttpUrlModifyPasswd, postData, new IAction<String>() {
			@Override
